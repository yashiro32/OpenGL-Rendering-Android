...
public abstract class ShaderProgram {
	...
	public ShaderProgram(String vertexFile, String fragmentFile, String geometryFile) {
		...
		geometryShaderID = loadShader(geometryFile, GLES31Ext.GL_GEOMETRY_SHADER_EXT);
	...
	public ShaderProgram(int vertexFileRes, int fragmentFileRes, String geometryFile, Context context) {
	...
	public void cleanUp() {
		...
		GLES30.glDetachShader(programID, geometryShaderID);
		GLES30.glDetachShader(programID, fragmentShaderID);
		GLES30.glDeleteShader(vertexShaderID);
		GLES30.glDeleteShader(geometryShaderID);
