...
public class MetaFile {
	 ...
	 */
	protected MetaFile(int resId, Context context) {
		this.aspectRatio = (double) MasterRenderer.mWidth / (double) MasterRenderer.mHeight;
		openFile(resId, context);
		loadPaddingData();
		loadLineSizes();
	 ...
	 * @param variable
	 * - the name of the variable.
	 * @return The int array of the values associated with the variable.
	 */
	 ...
	 * - the font file.
	 */
	private void openFile(int resId, Context context) {
